...
% ----  Esse comandos s?o necess?rio no pr?-ambulo para a impress?o da lista de lista abreviatuas e de s?mbolos
\makelosymbols
\makeloabbreviations
% ---- In?cio do documento
\begin{document}
  % ---- Descri??o do t?tulo do trabalho 
  \title{Título do trabalho com ça va}
  % ---- Nome do autor ou autores do trabalho
  \author{Autor}{Sobrenome}
  % ---- Nome do orientador do trabalho. O ?ltimo campo representa o t?tulo do professor
  ...
  % ---- Departamento representa o curso ao qual o trabalho est? sendo apresentado. Descrito por meio de duas iniciais do curso
  \department{CC}
  % ---- Data da apresenta??o do trabalho
  \date{25}{03}{2016}
  % ---- Palavras-chaves em portugu?s do trabalho
  \keyword{\LaTeX}
  \keyword{\uftex}
  \keyword{Trabalho de Conclus?o de Curso}
  \keyword{Reda??o Cient?fica}
  \keyword{Extens?o Universit?ria}
  % ---- Palavras-chaves em ingl?s do trabalho
  ...
  % ---- Comando respons?vel por criar a capa do trabalho, logo em seguida est? o comando que insere a folha de rosto conforme a configura??o exigida
 \maketitle
...
% Esse comando Insere a Folha de Rosto
  ...
  % ----------------------------------------------------------------------------------------------------- %
  %  Este trecho deve ser inserido somente no caso do TCC2 j? na vers?o FINAL
  % ----------------------------------------------------------------------------------------------------- %
  \includepdf{ficha_catalografica}
  
  % ----------------------------------------------------------------------------------------------------- %
  % Esse comando insere a Folha de Aprova??o
  \makepageapprove
  ...
  % ----------------------------------------------------------------------------------------------------- %
  \dedication{A algu?m cujo valor ? digno desta dedicat?ria.}
  ...
  \listoftables 
  % ---- Cria o sum?rio. OBRIGAT?RIO
  \tableofcontents % sum?rio
% --- Marca o inicio dos elementos textuais. Cap?tulos.
\mainmatter
% ---- Defino o espa?amento de um e meio cent?metros
\onehalfspacing
% ----------------------------------------------------------------------------------------------------- %
...
\lipsum[1] \cite{JW82} \symbl{$\phi$}{Defini??o do S?mbolo 1} \symbl{$\Omega$}{Defini??o do S?mbolo 2}

\lipsum[2] \cite{MenaChalco08} \abbrev{UFT}{Universidade Federal do Tocantins}\abbrev{CUP}{Campus Universit?rio de Palmas}
